...
export default function ProfileSidebar({ isOpen, onClose, session }: ProfileSidebarProps) {
    ...
    const handleSave = async (autoResumeFile?: File) => {
        if (!token) return;
        setSaving(true);
        setSaved(false);
        ...
        try {
            ...
            const fileToUpload = autoResumeFile || resume;
            if (fileToUpload) {
            ...
            >
                ...
                <div className="flex-1 overflow-y-auto">
                    ...
                    <div className="p-4 border-b border-slate-700/50">
                        ...
                        {userName && (
                            <div className="mb-6 bg-slate-800/80 rounded-lg p-3 border border-slate-700">
